    ...
    <>
      <div className="container">
        ...
        <div className={`row mb-5 mt-2 mx-2 ${isScreenSmall ? "justify-content-center" : "flex-nowrap"}`}>
          <div className={`col-md-3 rounded-4 p-0 ${isScreenSmall ? "" : ""}`}>
            <div className="mx-2 light-green rounded-4">
              <div>
                <img src={laptop} className="w-100 rounded-top-4" alt="" />
              </div>
          ...
          <div className={`col-md-3 p-0 ${isScreenSmall ? "my-4" : ""}`}>
            <div className="mx-2 light-green rounded-4">
              <div>
                <img src={people} className="w-100 rounded-top-4" alt="" />
              </div>
              <div className="row justify-content-between">
                <div className="col-md-5 d-flex align-items-center">
                  <div className={`${Style.play}`}>
          ...
          <div className={`col-md-3 p-0 ${isScreenSmall ? "my-4" : ""}`}>
            <div className="mx-2 light-green rounded-4">
              <div>
                <img src={code} className="w-100 rounded-top-4" alt="" />
              </div>
              <div className="row justify-content-between">
                <div className="col-md-5 d-flex align-items-center">
                  <div className={`${Style.play}`}>
