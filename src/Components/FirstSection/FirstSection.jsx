    ...
    <div className="row justify-content-between">
           ...
           <div className={`d-flex align-items-center ${
            isScreenSmall ? '' : 'ms-5'
                ...
                }`}><span className={`${Style.goldfont}`}>Studying</span> Online is now much easier</h4>
            </div>
            <p className={`text-white fs-6  no-bold ${
                isScreenSmall? 'mx-3 px-0 mt-0 text-center' : 'mx-5 px-5 mt-4'}`}>USAM is an interesting platform that will teach you in more an interactive way</p>
          <div className="ps-5 ms-5 w-100">
          <Link to={'/pricing'} className={`btn ms-5 bg-green py-2 px-4  text-white rounded-5 ${
            ...
            <div className="col-md-5">
                <div className={`w-100 position-relative  ${
                    ...
                    <div className="mt-4">
                        <div className={`${Style.boxOne} px-3 py-2 rounded-4 d-flex align-items-center`}>
                            <div className="bg-color d-flex align-items-center justify-content-center rounded-2 me-2" style={{width :'35px' , height : '35px'}}>
                 ...
                 <div className={`row position-absolute  ${
                    isScreenSmall ? 'start-0 mb-5' : 'bottom-50 mb-5 start-0 translate-middle-x'
                 }`}>
                 ...
                 <div className={`row position-absolute  ${
                    isScreenSmall ? 'top-50 start-0 ms-2' : 'top-50 start-50 translate-middle-x'
                 }`}>
                        <div className={`${Style.boxOne} px-3 py-2 rounded-4 d-flex align-items-center`}>
                        <div className="bg-gold d-flex align-items-center justify-content-center rounded-2 me-2" style={{width :'35px' , height : '35px'}}>
                 ...
                 <div className="">
                        ...
                        <div className=" d-flex align-items-center justify-content-center rounded-2 me-2" style={{width :'35px' , height : '35px'}}>
                        <div className="position-relative">
                        <img src={active} className="w-100" alt="" />
                        <div className={`${Style.active} position-absolute rounded-5 border border-1 border-white bottom-0 end-0 p-1`}>
                        ...
                        <button className="btn bg-gold text-white rounded-5 py-1 px-4 my-1 small-font">Join Now</button>
                        </div>
                         </div>
